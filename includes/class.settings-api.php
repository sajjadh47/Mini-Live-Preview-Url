 ...
 */
if ( ! class_exists( 'WpMiniLivePreviewUrl_Settings_API' ) ):

class WpMiniLivePreviewUrl_Settings_API {
    ...
    function admin_enqueue_scripts() {
        ...
        wp_enqueue_style( 'wp-color-picker' ); // load jQuery UI color picker widget css
        wp_enqueue_media(); // load WP Media Uploader Modal scripts
        wp_enqueue_script( 'wp-color-picker' ); // load jQuery UI color picker widget css
     ...
     * @param array   $args settings field args
     */
    function callback_categories( $args ) {
